...
const RegistroProd = () => {
  ...
  const sendData = (data) => {
    setPropNumber(data.value);
  };

  const cadastrarProducao = async (url) => {
    if (produtor == "" || produtor == null || produtor == "undefined") {
      ...
      toast.warn("Adicione o número da proposta", {
        theme: "colored",
      });
    } else {
      if (url == "" || url == null || url == "undefined") {
        ...
        const isValid = allProp.filter(
          (prop) => prop.numeroProposta == propNumber
        );
        ...
        if (isValid.length == 0) {
          ...
          toast.warn("Essa Proposta ja foi cadastrada", {
            theme: "colored",
          });
        }
      }
          ...
          <div className="formR">
            ...
            <div className="rowReg">
              <InputBase
                ...
                spanPlaceholder={"Número da proposta"}
                idProps={"propNumber"}
                sendData={sendData}
                typeProps={"text"}
              />
